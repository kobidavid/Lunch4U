...
void main() => runApp(FullMealMonday());

class FullMealMonday extends StatelessWidget {
  @override
...
class _MyHomePageState extends State<MyHomePage> {
  List<String> saladsList = [
    ...
    'טחינה גלילית',
    'מיקס חמוצי הבית',
    'סלט כרוב לבן בתחמיץ לימון',
  ];

  List<String> carboList = [
    'אורז אדום',
    'קוביות תפוח אדמה אפויים בשמן זית וקייגין',
    'שעועית צהובה בציר ירקות שורש',
  ];
