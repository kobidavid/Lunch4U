...
void main() => runApp(FullMealTuesday());

class FullMealTuesday extends StatelessWidget {
  @override
...
class _MyHomePageState extends State<MyHomePage> {
  List<String> saladsList = [
    ...
    'טחינה גלילית',
    'מיקס חמוצי הבית',
    'בשר חציל קלוי בגריל במיונז וקונפי שום',
  ];

  List<String> carboList = [
    'אורז בסמטי ואורז בר',
    'קוסקוס לבן מסורתי',
    'ירקות שורש אפויים גרגירי חומוס וכרוב בזעפרן',
  ];

  List<String> mainCourseList = [
    'פילה דג ברוטב חריימה',
    'חזה עוף במרינאדה פפריקה ושום צלוי על הפלנצה',
    'פפריקוש– קוביות בשר עגל ותפוח אדמה',
    'שניצל תירס',
  ];
